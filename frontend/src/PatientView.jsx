...
const PatientView = () => {
  const [messages, setMessages] = useState([
    { id: 1, from: 'Dr. Smith', subject: 'Follow-up Appointment', date: '2025-02-15' },
    { id: 2, from: 'Physical Therapy', subject: 'Exercise Plan Update', date: '2025-02-14' }
  ]);
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto space-y-6 text-gray-900">
      <h1 className="text-3xl font-bold mb-8 text-gray-900">Patient Dashboard</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          <div className="mb-4">
            <h2 className="text-xl font-semibold text-gray-900">Treatment Milestones</h2>
          </div>
