...
import { ClipboardList, Upload, Trash2, Eye, ArrowLeft, PlusCircle, File } from "lucide-react";


const MedicalHistoryPage = () => {

  const [medicalRecords, setMedicalRecords] = useState([
    { id: 1, name: "Annual Physical Exam 2024.pdf", date: "Feb 10, 2025", size: "2.4 MB" },
    { id: 2, name: "Vaccination Records.pdf", date: "Jan 15, 2025", size: "1.2 MB" },
    { id: 3, name: "Allergy Test Results.pdf", date: "Dec 22, 2024", size: "3.1 MB" }
  ]);
      ...
      <div className="w-full mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-800 flex items-center">
            <ClipboardList className="h-6 w-6 sm:h-8 sm:w-8 mr-2 text-blue-600" />
          ...
          <div className="p-4 sm:p-6">
            <div className="mb-6">
              <p className="text-gray-700 mb-4">
                View and manage your medical history records. You can upload new files, view existing ones, or delete records you no longer need.
              </p>
              
              {/* Upload Section */}
              {uploadingFile ? (
                <div className="bg-blue-50 border border-blue-200 rounded-md p-4 mb-4">
                  <h3 className="font-medium text-blue-700 mb-2">Upload Medical Record</h3>
